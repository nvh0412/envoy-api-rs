...
impl serde::Serialize for BindConfig {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.local_address_selector.as_ref() {
            struct_ser.serialize_field("localAddressSelector", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for grpc_service::EnvoyGrpc {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.max_receive_message_length.as_ref() {
            struct_ser.serialize_field("maxReceiveMessageLength", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for HeaderValue {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.raw_value.is_empty() {
            #[allow(clippy::needless_borrow)]
            struct_ser.serialize_field("rawValue", pbjson::private::base64::encode(&self.raw_value).as_str())?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for HealthCheck {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.event_logger.is_empty() {
            struct_ser.serialize_field("eventLogger", &self.event_logger)?;
        }
        ...
        if self.always_log_health_check_success {
            struct_ser.serialize_field("alwaysLogHealthCheckSuccess", &self.always_log_health_check_success)?;
        }
...
impl serde::Serialize for Http1ProtocolOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if self.allow_custom_methods {
            struct_ser.serialize_field("allowCustomMethods", &self.allow_custom_methods)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for Http2ProtocolOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.use_oghttp2_codec.as_ref() {
            struct_ser.serialize_field("useOghttp2Codec", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for JsonFormatOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if self.sort_properties {
            struct_ser.serialize_field("sortProperties", &self.sort_properties)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for QuicProtocolOptions {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.connection_options.is_empty() {
            struct_ser.serialize_field("connectionOptions", &self.connection_options)?;
        }
        if !self.client_connection_options.is_empty() {
            struct_ser.serialize_field("clientConnectionOptions", &self.client_connection_options)?;
        }
        if let Some(v) = self.idle_network_timeout.as_ref() {
            struct_ser.serialize_field("idleNetworkTimeout", v)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for SubstitutionFormatString {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.json_format_options.as_ref() {
            struct_ser.serialize_field("jsonFormatOptions", v)?;
        }
