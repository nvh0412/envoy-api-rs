...
impl serde::Serialize for CorsPolicy {
        ...
        S: serde::Serializer,
    {
        ...
        if let Some(v) = self.forward_not_matching_preflights.as_ref() {
            struct_ser.serialize_field("forwardNotMatchingPreflights", v)?;
        }
...
impl serde::Serialize for InternalRedirectPolicy {
        ...
        S: serde::Serializer,
    {
        ...
        if !self.response_headers_to_copy.is_empty() {
            struct_ser.serialize_field("responseHeadersToCopy", &self.response_headers_to_copy)?;
        }
        struct_ser.end()
    }
}
...
impl serde::Serialize for route_action::RequestMirrorPolicy {
        ...
        S: serde::Serializer,
    {
        ...
        if self.disable_shadow_host_suffix_append {
            struct_ser.serialize_field("disableShadowHostSuffixAppend", &self.disable_shadow_host_suffix_append)?;
        }
        struct_ser.end()
    }
}
