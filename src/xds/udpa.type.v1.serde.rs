...
impl serde::Serialize for TypedStruct {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("udpa.r#type.v1.TypedStruct", len)?;
        if !self.type_url.is_empty() {
...
impl<'de> serde::Deserialize<'de> for TypedStruct {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct udpa.r#type.v1.TypedStruct")
            }
        ...
        deserializer.deserialize_struct("udpa.r#type.v1.TypedStruct", FIELDS, GeneratedVisitor)
    }
}
