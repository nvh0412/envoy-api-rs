...
impl serde::Serialize for Resource {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.core.v3.Resource", len)?;
...
impl<'de> serde::Deserialize<'de> for Resource {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.core.v3.Resource")
            }
        ...
        deserializer.deserialize_struct("xds.core.v3.Resource", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ResourceName {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.core.v3.ResourceName", len)?;
        if !self.id.is_empty() {
            struct_ser.serialize_field("id", &self.id)?;
        }
        if !self.authority.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResourceName {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.core.v3.ResourceName")
            }
        ...
        deserializer.deserialize_struct("xds.core.v3.ResourceName", FIELDS, GeneratedVisitor)
    }
}
