...
impl serde::Serialize for OrcaLoadReportRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("xds.service.orca.v3.OrcaLoadReportRequest", len)?;
...
impl<'de> serde::Deserialize<'de> for OrcaLoadReportRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct xds.service.orca.v3.OrcaLoadReportRequest")
            }
        ...
        deserializer.deserialize_struct("xds.service.orca.v3.OrcaLoadReportRequest", FIELDS, GeneratedVisitor)
    }
}
